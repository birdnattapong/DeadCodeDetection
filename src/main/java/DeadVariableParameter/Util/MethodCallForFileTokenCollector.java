...
//                System.out.println("String is not in method line between " + this.methodTokenList.get(i).getBeginLine() + " - " + this.methodTokenList.get(i).getEndLine());
            ...
            if (vd.getParentNodeForChildren().toString().contains("System.out.")) {
                String methodCall = vd.getParentNodeForChildren().toString();
                String newString = methodCall.substring(methodCall.indexOf("("));
                this.MethodCall.add(newString);
            } else if (!vd.getParentNodeForChildren().toString().contains("System.out.")) {
