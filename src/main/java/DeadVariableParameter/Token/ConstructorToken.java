...
public class ConstructorToken {
    ...
    private List<ObjectVariableToken> objectVariableToken = new ArrayList<>();
    private List<ObjectParameterToken> objectParameterToken = new ArrayList<>();
    ...
    private List<String> explicitConstructorStmt = new ArrayList<>();
    ...
    public List<ObjectVariableToken> getVariable() {
        return objectVariableToken;
    }

    public void setVariable(List<ObjectVariableToken> objectVariableTokenList) {
        this.objectVariableToken = objectVariableTokenList;
    }

    public List<ObjectParameterToken> getParameterToken() {
        return objectParameterToken;
    }

    public void setParameterToken(List<ObjectParameterToken> objectParameterToken) {
        this.objectParameterToken = objectParameterToken;
    }
    ...
    public void setExplicitConstructorStmt(List<String> explicitConstructorStmt) {
        this.explicitConstructorStmt = explicitConstructorStmt;
    }

    public List<String> getExplicitConstructorStmt() {
