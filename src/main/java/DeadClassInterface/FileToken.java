...
import DeadClassInterface.Util.*;
...
public class    FileToken {
    ...
    private final List<String> notations = new ArrayList<>();


    /* All used util classes.
    ...
    public FileToken(CompilationUnit cu) {
        ...
        // Case 10 : Notation
        NotationCollector notationCollector = new NotationCollector();
        notationCollector.visit(cu,notations);
